...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/TmaxCinema'),
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://t.me/+JeWFhkIdXkdiNzc1')
                 ]]
        reply_markup=InlineKeyboardMarkup(buttons)
            ...
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_photo(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           InlineKeyboardButton('ᴘʀᴇᴍɪᴜᴍ', url='https://t.me/+JeWFhkIdXkdiNzc1'),
                                                                           InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://t.me/TmaxCinema')
                                                                        ]]
                                                 ),
