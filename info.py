...
OWNER_ID = environ.get('OWNER_ID', '1294939227')
BOT_TOKEN = environ.get('BOT_TOKEN', "5734934809:AAEsM5xnzWuhCuAJAHqQYaOZ_ZGW0X6kdRk")
...
BOT_USERNAME = environ.get("BOT_USERNAME", "Carlafilterbot")
BOT_NAME = environ.get("BOT_NAME", "Carla")
BOT_ID = environ.get("BOT_ID", "5734934809")
S_GROUP = environ.get('S_GROUP', "")
S_CHANNEL = environ.get('S_CHANNEL', "TamxCinema")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+-8G-JdBegzQyYmM1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+v1NoAgylODczNDk1')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+42J3xSpA0GJjODU1') #Support group link ( make sure bot is admin )
